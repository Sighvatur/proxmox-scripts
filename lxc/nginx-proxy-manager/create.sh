...
# Base raw github URL https://raw.githubusercontent.com/Sighvatur/proxmox-scripts/main/lxc/nginx-proxy-manager/create.sh
_raw_base="https://raw.githubusercontent.com/Sighvatur/proxmox-scripts/main/lxc/nginx-proxy-manager"
# Operating system
_os_type=alpine
_os_version=3.12
# System architecture
