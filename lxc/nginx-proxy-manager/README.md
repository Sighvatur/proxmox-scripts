...
```bash
curl -sL https://raw.githubusercontent.com/Sighvatur/proxmox-scripts/tree/main/lxc/nginx-proxy-manager/create.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/Sighvatur/proxmox-scripts/tree/main/lxc/nginx-proxy-manager/create.sh | bash -s -- --cores 4
```
